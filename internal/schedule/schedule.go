...
//
// estate-scraper: cron "0 2 * * 5" — runs npm scan against estatesales.net,
...
// It returns false during the estate-scraper window, when the GPU is needed
// for heavy Ollama inference.
func SafeForBackgroundGPU(t time.Time) bool {
	return !InWindow("estate-scraper", t)
}

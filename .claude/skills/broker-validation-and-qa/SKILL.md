...
| `internal/schedule` | — | **NOTHING** | first test should pin window boundaries (Fri 01:59/02:00/06:59/07:00 for internal-scraper-service) — read `contains()` first; mind `t.Local()` |
...
- Duration: multi-day, MUST include at least one gaming session, one Plex transcode, and one Friday 02:00–07:00 internal-scraper-service window.

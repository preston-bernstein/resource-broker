...
description: >
  Operate the deployed ollama-resource-broker on the desktop (10.0.0.243):
...
(10.0.0.243) whose one GPU (AMD RX 9070 XT) is shared, in priority order:
